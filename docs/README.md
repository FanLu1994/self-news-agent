...
- 📰 自动生成可订阅的 RSS 摘要文件
- 📝 自动生成 `docs/daily/YYYY-MM-DD.md` 并更新 README 为最新新闻内容
...
完整内容: [docs/daily/2026-02-21.md](docs/daily/2026-02-21.md)
<!-- digest:latest:end -->
...
| Topic | 7d | 30d | 近7天分布 |
| --- | --- | --- | --- |
| Other | 141 | 141 | 0, 0, 0, 0, 44, 47, 50 |
| AI | 134 | 134 | 0, 0, 0, 0, 47, 43, 44 |
| Data | 36 | 36 | 0, 0, 0, 0, 13, 9, 14 |
| Frontend | 15 | 15 | 0, 0, 0, 0, 5, 5, 5 |
| Backend | 7 | 7 | 0, 0, 0, 0, 2, 3, 2 |
| OpenSource | 6 | 6 | 0, 0, 0, 0, 2, 2, 2 |
| Security | 3 | 3 | 0, 0, 0, 0, 2, 1, 0 |
| Mobile | 3 | 3 | 0, 0, 0, 0, 1, 2, 0 |
| Startup | 3 | 3 | 0, 0, 0, 0, 1, 1, 1 |
| Cloud | 2 | 2 | 0, 0, 0, 0, 1, 1, 0 |
<!-- digest:trend:end -->
...
npm start
```
执行流程：抓取新闻 → AI 分析 → 生成 Markdown → 更新 README → Telegram/邮件推送

**Telegram 对话模式：**
```bash
npm run telegram
```
启动 Bot 后，可以直接发消息询问新闻问题，例如：
- "最近3天 AI Agent 有什么进展？"
- "今天 GitHub Trending 上有什么热门项目？"
...
- `OPENAI_BASE_URL`（DeepSeek API：`https://api.deepseek.com`）
...
**邮件推送（可选）**：
- `EMAIL_ENABLED`、`RESEND_API_KEY`、`EMAIL_FROM`、`EMAIL_TO`
